...
public abstract class MeteSaca<T> {
    ...
    public boolean equals(Object object) {
        ...
        if (getClass() == object.getClass()) {
            Nodo meteUno = this.cabeza;
            Nodo meteDos = m.cabeza;
            ...
            while (meteUno != null) {
                ...
                if (meteUno.elemento.equals(meteDos.elemento)) {
                    meteUno = meteUno.siguiente;
                    meteDos = meteDos.siguiente;
                } else
                    return false;
            }
            return true;
